...
const PowerUps: PowerUps = {
  ...
  ///// todo Stop Ball When it hits Paddle
  // todo Move the ball with the paddle where it landed
  // todo shoot the ball once the ENTER key is pressed
  stickyPaddle: <stickyPaddle>{
    effect(ball: Ball, paddle: Paddle) {
